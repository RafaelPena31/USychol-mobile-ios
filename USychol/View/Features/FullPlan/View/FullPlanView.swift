...
final public class FullPlanView: UIView {
    ...
    private lazy var containerView: UIView = {
        ...
        let gradientStyle = GradientStyle(bounds: UIScreen.main.bounds, color: .green, parentLayer: view)
    ...
    private lazy var price: CoreLabel = CoreLabel(type: .logo, text: "$99,90", color: "WhiteColor")
    private lazy var priceLabel: CoreLabel = CoreLabel(type: .text, text: "/month", color: "WhiteColor")
    private lazy var planTitle: CoreLabel = CoreLabel(type: .logo, text: "Full Psychologist", color: "WhiteColor")
    private lazy var planDesc: CoreLabel =
        CoreLabel(
            type: .text,
            text: "Unlock the power of both plans and get access to Analytics Dash and Psycho Dash 24/7",
            color: "WhiteColor"
        )
    ...
    private lazy var benefitViewTwo: CorePlanField = CorePlanField(text: "All features of the Digital Psychologist plan")
    private lazy var benefitViewThree: CorePlanField = CorePlanField(text: "All features of the Digital Psychologist plan")
    private lazy var benefitViewFour: CorePlanField = CorePlanField(text: "Registration of up to 40 patients")

    private lazy var button: CoreButton = CoreButton(type: .light, title: "Sign Plan", onPressMethod: onHandleClick)
    ...
    public weak var delegate: FullPlanViewDelegate?
    ...
    private func addConstraints() {
        ...
        benefitViewThree.snp.makeConstraints{(make) -> Void in
            make.top.equalTo(benefitViewTwo).inset(48)
    ...
    private func updateView(with entity: FullPlanViewEntity) {
...
extension FullPlanView: FullPlanViewType {
