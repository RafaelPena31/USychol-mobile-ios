...
final public class DigitalPlanView: UIView {
    ...
    private lazy var containerView: UIView = {
        ...
        let gradientStyle = GradientStyle(bounds: UIScreen.main.bounds, color: .blue, parentLayer: view)
    ...
    private lazy var price: CoreLabel = CoreLabel(type: .logo, text: "$79,90", color: "WhiteColor")
    private lazy var priceLabel: CoreLabel = CoreLabel(type: .text, text: "/month", color: "WhiteColor")
    private lazy var planTitle: CoreLabel = CoreLabel(type: .logo, text: "Digital Psychologist", color: "WhiteColor")
    ...
    public weak var delegate: DigitalPlanViewDelegate?
    ...
    private func updateView(with entity: DigitalPlanViewEntity) {
...
extension DigitalPlanView: DigitalPlanViewType {
